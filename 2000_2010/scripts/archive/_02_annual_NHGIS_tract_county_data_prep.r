# 03_annual_NHGIS_tract_county_data_prep.r
# David Van Riper
# 2018-11-20
# 
# This script creates annual tract and county data from 2000-2010. It uses NHGIS standardized data
# for the processing. It ends by creating linearish interpolated data from 2000-04-01 to 2010-04-01,
# with the intervening years for the date YYYY-07-01.
# 
# This script must be run twice - once to process NHGIS tract data and once to process NHGIS county
# data. Eventually, I will make the script more flexible or callable from other code. It also 
# currently works for one state's worth of data (for speed's sake).
# 
# After running the county data, I need to put it in a data frame called XXXXX. 
# 
# 2018-11-20
